...
class AdditionalRangeNormalizer(dptrangenormalizerbase.RangeNormalizerBase):
    """
    This class can normalize a batch of RGB image patches with [0.0, 1.0] np.float32 value range that were extracted from whole-slide images to a target value range.
    """
    ...
    def process(self, patches):
        ...
        for spacing in patches:
            ...
            #
            patches[spacing]['patches'] = patches[spacing]['patches'] * self.__target_range_size + self.__target_range[0]
