...
def binary_dice(output, target, axis = None, smooth=1e-10):
...
def main():
    ...
    print("creating model for {} classes".format(len(sampler_param['training']['label_dist'])))
    model = init_model(model_param, len(sampler_param['training']['label_dist']))
    ...
    model.fit(train_datagen,
              ...
              max_queue_size=training_param['workers'],
